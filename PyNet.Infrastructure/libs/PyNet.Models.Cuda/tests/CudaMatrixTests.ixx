...
export module PyNet.Models.Cuda.Tests:CudaMatrixTests;
...
namespace PyNet::Models::Cuda::Tests
{
	...
	public:
		...
		TEST_METHOD(Matrix_SubtractCalled_ReturnsCorrectResult)
		{
			...
			Assert::AreEqual(0.5, (*result)(0, 0));
			Assert::AreEqual(1.5, (*result)(0, 1));
			Assert::AreEqual(2.5, (*result)(1, 0));
			Assert::AreEqual(3.5, (*result)(1, 1));
			Assert::AreEqual(4.5, (*result)(2, 0));
			Assert::AreEqual(5.5, (*result)(2, 1));
		}
		...
		TEST_METHOD(Matrix_MultiplyCalled_ReturnsCorrectResult)
		{
			...
			Assert::AreEqual(1.75, (*result)(0, 0));
			Assert::AreEqual(2.5, (*result)(0, 1));
			Assert::AreEqual(3.75, (*result)(1, 0));
			Assert::AreEqual(5.5, (*result)(1, 1));
			Assert::AreEqual(5.75, (*result)(2, 0));
			Assert::AreEqual(8.5, (*result)(2, 1));
		}
		...
		TEST_METHOD(Matrix_MultiplyDoubleCalled_ReturnsCorrectResult)
		{
			...
			Assert::AreEqual(10.0, (*result)(0, 1));
			Assert::AreEqual(15.0, (*result)(1, 0));
			Assert::AreEqual(20.0, (*result)(1, 1));
			Assert::AreEqual(25.0, (*result)(2, 0));
			Assert::AreEqual(30.0, (*result)(2, 1));
		}
	};
}